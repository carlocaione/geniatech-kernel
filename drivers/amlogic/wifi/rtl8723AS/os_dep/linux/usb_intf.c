...
#error 5555555555555555555555555
...
#error 2222222222222222222222222222
...
static int __init rtw_drv_entry(void)
{
	...
	printk(DRV_NAME " driver version=%s\n", DRIVERVERSION);

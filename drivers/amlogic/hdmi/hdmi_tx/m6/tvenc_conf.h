...
static  reg_t hdmi_tvenc_regs_640x480x60[] = {
    {ENCP_VIDEO_MODE,                    0x00004040},
    {ENCP_DE_H_BEGIN,                    0x00000112},
...
static  reg_t hdmi_tvenc_regs_800x600x60[] = {
    //{ENCP_VIDEO_MODE,                    0x00004040},
    //{ENCP_DE_H_BEGIN,                    0x00000112},
    //{ENCP_DE_H_END,                      0x00000612},
    //{ENCP_DE_V_BEGIN_EVEN,               0x00000029},
...
static  reg_t hdmi_tvenc_regs_1024x768x60[] = {
    //{ENCP_VIDEO_MODE,                    0x00004040},
    //{ENCP_DE_H_BEGIN,                    0x00000112},
    //{ENCP_DE_H_END,                      0x00000612},
    //{ENCP_DE_V_BEGIN_EVEN,               0x00000029},
...
static  reg_t hdmi_tvenc_regs_1440x900x60[] = {
    //{ENCP_VIDEO_MODE,                    0x00004040},
    //{ENCP_DE_H_BEGIN,                    0x00000112},
    //{ENCP_DE_H_END,                      0x00000612},
    //{ENCP_DE_V_BEGIN_EVEN,               0x00000029},
...
static  reg_t hdmi_tvenc_regs_1680x1050x60[] = {
    //{ENCP_VIDEO_MODE,                    0x00004040},
    //{ENCP_DE_H_BEGIN,                    0x00000112},
    //{ENCP_DE_H_END,                      0x00000612},
    //{ENCP_DE_V_BEGIN_EVEN,               0x00000029},
...
static const hdmi_tvenc_config_t hdmi_tvenc_configs[] = {
    {HDMI_640x480p60  ,          hdmi_tvenc_regs_640x480x60},
    ...
    {HDMI_1280_1024,             hdmi_tvenc_regs_1280x1024x60},
    ...
    {HDMI_800x600,               hdmi_tvenc_regs_800x600x60},
    {HDMI_1024x768,              hdmi_tvenc_regs_1024x768x60},
    {HDMI_1440x900,              hdmi_tvenc_regs_1440x900x60},
    {HDMI_1680x1050,             hdmi_tvenc_regs_1680x1050x60},
    {HDMI_Unkown,               NULL},
};

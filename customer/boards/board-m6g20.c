...
static struct aml_card_info meson_card_info[] = {
    ...
    [1] = {
        ...
        .card_power_en_reg  = 0,//EGPIO_GPIOC_ENABLE,
        .card_power_en_mask = 0,//PREG_IO_7_MASK,
        .card_power_output_reg  = 0,//EGPIO_GPIOC_OUTPUT,
        .card_power_output_mask = 0,//PREG_IO_7_MASK,
        .card_power_en_lev  = 0,
        .card_wp_en_reg     = 0,
        .card_wp_en_mask    = 0,
        .card_wp_input_reg  = 0,

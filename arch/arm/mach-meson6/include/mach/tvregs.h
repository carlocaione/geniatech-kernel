...
static const reg_t tvregs_vga_640x480[] = { // 25.17mhz 800 *525
    ...
    {ENCP_VIDEO_YFP1_HTIME,      244,   },
    {ENCP_VIDEO_YFP2_HTIME,      1630,  },
    {ENCP_VIDEO_MAX_PXCNT,       799,  },
    {ENCP_VIDEO_MAX_LNCNT,       524,   },
    {ENCP_VIDEO_HSPULS_BEGIN,    0,  },
    {ENCP_VIDEO_HSPULS_END,      96,  },
    {ENCP_VIDEO_HSPULS_SWITCH,   88,    },
    {ENCP_VIDEO_VSPULS_BEGIN,    0,     },
    {ENCP_VIDEO_VSPULS_END,      0   },
    {ENCP_VIDEO_VSPULS_BLINE,    0,     },
    {ENCP_VIDEO_VSPULS_ELINE,    2,     },
    {ENCP_VIDEO_HAVON_BEGIN,     145,   },
    {ENCP_VIDEO_HAVON_END,       784,  },
    {ENCP_VIDEO_VAVON_BLINE,     35,    },
    {ENCP_VIDEO_VAVON_ELINE,     515,   },
...
static const reg_t tvregs_svga_800x600[]={ //39.5mhz 1056 *628
 ...
 static const reg_t tvregs_xga_1024x768[] = {
    ...
    {ENCP_VIDEO_MAX_PXCNT,       1343,  },
    {ENCP_VIDEO_MAX_LNCNT,       805,   },
    {ENCP_VIDEO_HSPULS_BEGIN,    0,    },
    {ENCP_VIDEO_HSPULS_END,      136,   },
    {ENCP_VIDEO_HSPULS_SWITCH,   80,    },
    {ENCP_VIDEO_VSPULS_BEGIN,    0,   },
    {ENCP_VIDEO_VSPULS_END,      0,  },
    {ENCP_VIDEO_VSPULS_BLINE,    0,     },
    {ENCP_VIDEO_VSPULS_ELINE,    6,     },
    {ENCP_VIDEO_EQPULS_BLINE,    0,     },
    {ENCP_VIDEO_EQPULS_ELINE,    5,     },
    {ENCP_VIDEO_HAVON_BEGIN,     297,   },
    {ENCP_VIDEO_HAVON_END,       1320,  },
    {ENCP_VIDEO_VAVON_BLINE,     35,    },
    {ENCP_VIDEO_VAVON_ELINE,     803,   },//827
    {ENCP_VIDEO_HSO_BEGIN,       0,    },
    {ENCP_VIDEO_HSO_END,         296,   },
    {ENCP_VIDEO_VSO_BEGIN,       0,   },
    {ENCP_VIDEO_VSO_END,         0,   },
    {ENCP_VIDEO_VSO_BLINE,       0,     },
...
static const reg_t tvregs_sxga_1280x1024[] = {
    ...
    {ENCP_VIDEO_YFP1_HTIME,      140,   },
    {ENCP_VIDEO_YFP2_HTIME,      2060,  },
    {ENCP_VIDEO_MAX_PXCNT,       1687,  },
    {ENCP_VIDEO_MAX_LNCNT,       1065,  },
    {ENCP_VIDEO_HSPULS_BEGIN,    1478,  },//1980
    {ENCP_VIDEO_HSPULS_END,      1590,    },
    {ENCP_VIDEO_HSPULS_SWITCH,   88,    },
    {ENCP_VIDEO_VSPULS_BEGIN,    1478,   },
    {ENCP_VIDEO_VSPULS_END,      1478,  },
    {ENCP_VIDEO_VSPULS_BLINE,    1065,  },
    {ENCP_VIDEO_VSPULS_ELINE,    2,     },//35
    {ENCP_VIDEO_HAVON_BEGIN,     151,   },
    {ENCP_VIDEO_HAVON_END,       1430,  },
    {ENCP_VIDEO_VAVON_BLINE,     41,    },
    {ENCP_VIDEO_VAVON_ELINE,     1065,  },
    {ENCP_VIDEO_HSO_BEGIN,       1478,  },
    {ENCP_VIDEO_HSO_END,         1590,  },
    {ENCP_VIDEO_VSO_BEGIN,       1478,  },
    {ENCP_VIDEO_VSO_END,         1478,  },
    {ENCP_VIDEO_VSO_BLINE,       1065,  },
    {ENCP_VIDEO_VSO_ELINE,       2,     },
    {VPU_VIU_VENC_MUX_CTRL,      0x000a,},      //New Add. If not set, when system boots up, switch panel to HDMI 1080P, nothing on TV.
    {VENC_VIDEO_PROG_MODE,       0x100, },
    {VENC_SYNC_ROUTE,            0,     },
...
static const reg_t tvregs_wxga[] = { //85.5M
    {VENC_VDAC_SETTING,          0xff,  },
    {ENCP_VIDEO_EN,              0,     },
    {ENCI_VIDEO_EN,              0,     },
    ...
    {ENCP_VIDEO_YFP1_HTIME,      216,   },
    {ENCP_VIDEO_YFP2_HTIME,      216+1368,  },
    {ENCP_VIDEO_MAX_PXCNT,       1800-1,  },
    {ENCP_VIDEO_MAX_LNCNT,       795-1,   },

    {ENCP_VIDEO_HAVON_BEGIN,     216,   },
    {ENCP_VIDEO_HAVON_END,       216+1368-1,  },
    {ENCP_VIDEO_VAVON_BLINE,     23,    },
    {ENCP_VIDEO_VAVON_ELINE,     23+768-1,   },
    {ENCP_VIDEO_HSO_BEGIN,       0    },
    {ENCP_VIDEO_HSO_END,         144,   },
    {ENCP_VIDEO_VSO_BEGIN,       0,   },
    {ENCP_VIDEO_VSO_END,         10,   },
    {ENCP_VIDEO_VSO_BLINE,       0,     },
...
static const reg_t tvregs_vga_1440x900[] = {
    {VENC_VDAC_SETTING,          0xff,  },
    ...
    {ENCP_VIDEO_MAX_LNCNT,       925,  },
    {ENCP_VIDEO_HSPULS_BEGIN,    0,  },//1980
    {ENCP_VIDEO_HSPULS_END,      32,    },
    {ENCP_VIDEO_HSPULS_SWITCH,   88,    },
    {ENCP_VIDEO_VSPULS_BEGIN,    0,   },
    {ENCP_VIDEO_VSPULS_END,      0,  },
    {ENCP_VIDEO_VSPULS_BLINE,    0,     },
    {ENCP_VIDEO_VSPULS_ELINE,    6,     },//35
    {ENCP_VIDEO_HAVON_BEGIN,     113,   },
    {ENCP_VIDEO_HAVON_END,       1552,  },
    {ENCP_VIDEO_VAVON_BLINE,     23,    },
    {ENCP_VIDEO_VAVON_ELINE,     923,  },
    {ENCP_VIDEO_HSO_BEGIN,       0,    },
    {ENCP_VIDEO_HSO_END,         32,  },
    {ENCP_VIDEO_VSO_BEGIN,       0,  },
    {ENCP_VIDEO_VSO_END,         0,  },
    {ENCP_VIDEO_VSO_BLINE,       0,  },
    {ENCP_VIDEO_VSO_ELINE,       6,     },
...
static const reg_t tvregs_vga_1680x1050[] = {
    {VENC_VDAC_SETTING,          0xff,  },
    ...
    {ENCP_VIDEO_YFP1_HTIME,      140,   },
    {ENCP_VIDEO_YFP2_HTIME,      2060,  },
    {ENCP_VIDEO_MAX_PXCNT,       1839,  },
    {ENCP_VIDEO_MAX_LNCNT,       1079,  },
    {ENCP_VIDEO_HSPULS_BEGIN,    0,  },//1980
    {ENCP_VIDEO_HSPULS_END,      32,    },
    {ENCP_VIDEO_HSPULS_SWITCH,   88,    },
    {ENCP_VIDEO_VSPULS_BEGIN,    0,   },
    ...
    {ENCP_VIDEO_VSPULS_ELINE,    6,     },//35
    {ENCP_VIDEO_HAVON_BEGIN,     113,   },
    {ENCP_VIDEO_HAVON_END,       1792,  },
    {ENCP_VIDEO_VAVON_BLINE,     27,    },
    {ENCP_VIDEO_VAVON_ELINE,     1077,  },
    {ENCP_VIDEO_HSO_BEGIN,       0,    },
    {ENCP_VIDEO_HSO_END,         32,  },
    {ENCP_VIDEO_VSO_BEGIN,       0,  },
    {ENCP_VIDEO_VSO_END,         0,  },
...
static const reg_t tvregs_wuxga[] = { //193.16M
    {VENC_VDAC_SETTING,          0xff,  },
    {ENCP_VIDEO_EN,              0,     },
    {ENCI_VIDEO_EN,              0,     },
    ...
    {ENCP_VIDEO_YFP1_HTIME,      336,   },
    {ENCP_VIDEO_YFP2_HTIME,      336+1920,  },
    {ENCP_VIDEO_MAX_PXCNT,       2592-1,  },
    {ENCP_VIDEO_MAX_LNCNT,       1242-1,   },

    {ENCP_VIDEO_HAVON_BEGIN,     336,   },
    {ENCP_VIDEO_HAVON_END,       336+1920-1,  },
    {ENCP_VIDEO_VAVON_BLINE,     38,    },
    {ENCP_VIDEO_VAVON_ELINE,     38+1200-1,   },
    {ENCP_VIDEO_HSO_BEGIN,       0    },
    {ENCP_VIDEO_HSO_END,         208,   },
    {ENCP_VIDEO_VSO_BEGIN,       0,   },
    {ENCP_VIDEO_VSO_END,         10,   },
...
static const tvinfo_t tvinfoTab[] = {
    ...
    {.xres = 1368, .yres = 768, .id = "wxga"},
    {.xres = 1440, .yres = 900, .id = "1440x900"},
    {.xres = 1680, .yres = 1050, .id = "1680x1050"},
    {.xres = 1920, .yres = 1200, .id = "wuxga"},
};
